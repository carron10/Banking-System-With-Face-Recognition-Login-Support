            ...
            <script>
                $(function() {
                    var detector = new FaceDetector("facial_container", () => {
                        detector.login("<?php echo (getenv('FACE_AUTH_API') ? getenv('FACE_AUTH_API') . 'api/face_login' : "http://tekon.eastus2.cloudapp.azure.com:5000/api/face_login"); ?>", "<?php echo ($email) ?>", (token) => {
